#!/usr/bin/env python3
# Copyright (c) 2019 The DIVX developers
...
class BudgetProposalTest(CastleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid CASTLE address")
        assert_raises_rpc_error(-5, "Invalid CASTLE address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 CSTL allowed", self.nodes[0].preparebudget,
